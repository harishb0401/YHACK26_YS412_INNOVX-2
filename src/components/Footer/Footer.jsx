        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="space-y-3 text-sm">
            ...
            <ul className="space-y-2 text-[#DDEBD8]">
              ...
              <li>
                <Link to="/recycler/dashboard" className="hover:text-[#F2C94C] transition cursor-pointer">
                  {t("navRecycler")}
                </Link>
              </li>
              <li>
                <Link to="/collector/register-waste" className="hover:text-[#F2C94C] transition cursor-pointer">
                  {t("navGenerator")}
                </Link>
              </li>
              <li>
                <Link to="/admin/dashboard" className="hover:text-[#F2C94C] transition cursor-pointer">
                  {t("navAdmin")}
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3 text-sm">
            ...
            <ul className="space-y-2 text-[#DDEBD8]">
              ...
              <li>
                <Link to="/locations" className="hover:text-[#F2C94C] transition cursor-pointer">
                  {t("navLocations")}
                </Link>
              </li>
              <li>
                <Link to="/how-it-works" className="hover:text-[#F2C94C] transition cursor-pointer">
                  {t("navHowItWorks")}
                </Link>
              </li>
            </ul>

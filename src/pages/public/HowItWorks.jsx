...
export default function HowItWorks() {
  ...
  const steps = [
    ...
    },
    {
      ...
      subtitle: "Fair Price Validation",
      icon: <Calculator className="w-6 h-6 text-amber-600" />,
      summary: "Calculates fair price range using market benchmark rates and acceptable tolerances.",
      details: [
        "Fetches government reference price per kg/unit",
        "Applies pre-defined tolerance range (e.g. ±15% to ±25%)",
        "Flags predatory below-market bids instantly to protect collectors"
      ],
      badge: "Step 05"
    },
    {
      ...
      subtitle: "Smart Procurement Match",
      icon: <Users className="w-6 h-6 text-blue-600" />,
      summary: "System matches waste lots to authorized recyclers with matching requirements.",
      details: [
        "Filters verified recyclers authorized for this exact waste category",
        "Calculates distance & transport feasibility",
        "Recyclers submit transparent, binding purchase bids"
      ],
      badge: "Step 06"
    },
    {
      ...
      subtitle: "Secure Physical Exchange",
      icon: <Truck className="w-6 h-6 text-[#244936]" />,
      summary: "Scheduled pickup and secure physical collection between collector and recycler.",
      details: [
        "Pickup date and time coordination",
        "Physical QR verification scan at weighbridge",
        "Direct digital settlement into collector wallet"
      ],
      badge: "Step 07"
    },
    {
      ...
      subtitle: "EPR Compliance Record",
      icon: <FileCheck2 className="w-6 h-6 text-emerald-700" />,
      summary: "End-to-end traceability timeline completed with verifiable recovery certificate.",
      details: [
        "12-stage tamper-proof digital traceability trail",
        "Government CPCB compliant recovery certificate issued",
        "Full transparent transaction history recorded"
      ],
      badge: "Step 08"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-[#718078] font-medium leading-relaxed">
            From informal collection to certified industrial recycling — follow the complete 8-step journey built on transparent pricing and end-to-end traceability.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="text-center pb-2">
            <h3 className="text-2xl font-black text-[#203128]">All 8 Workflow Milestones</h3>
          </div>

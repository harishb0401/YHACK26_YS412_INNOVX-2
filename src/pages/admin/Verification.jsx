            ...
            {pendingRecyclers.map((rec) => (
              ...
              >
                <div className="space-y-1 text-xs">
                  ...
                  <p className="text-[#718078]">Location: {rec.location} • Contact: {rec.contactPerson} ({rec.phone || 'N/A'})</p>
                  <p className="text-[#718078]">CPCB Reg: <span className="font-mono font-bold text-[#203128]">{rec.cpcbRegistrationNo || rec.cpcbRegistrationNumber || 'PENDING'}</span></p>
                </div>

...
export default function AdminProfile({ adminProfile = mockAdmin }) {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl sm:text-3xl font-black text-[#203128]">Admin Profile</h1>
        <p className="text-xs sm:text-sm text-[#718078]">
          State Administrator account details and authority permissions.
        </p>
      </div>
      ...
      <div className="bg-white p-6 sm:p-10 rounded-[32px] border border-[#3F7655]/20 shadow-md space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#3F7655]/10 pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[#718078] mt-0.5">TNPCB E-Waste Regulatory Board</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="text-xs font-extrabold text-[#203128] block mb-1">Department</label>
              <input
                type="text"
                disabled={!isEditing}

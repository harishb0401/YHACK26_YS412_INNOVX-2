      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#DDEBD8] text-[#244936] text-xs font-bold uppercase tracking-wider">
            <BookOpen className="w-3.5 h-3.5" /> Comprehensive Recycling Directory
          </span>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-[#203128] tracking-tight">
            Recycling Guide & Preparation Rules
          </h1>
          <p className="text-base text-[#718078]">
            What do you want to recycle today? Find clean sorting instructions, prep steps, and non-recyclable warnings.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-[28px] border border-[#3F7655]/15 shadow-sm space-y-5">
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <input
              ...
              placeholder="Search materials (e.g. Cardboard, Shampoo bottles, Glass jars...)"
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
            <span className="text-xs font-bold text-[#718078] mr-1">Categories:</span>
          ...
          <div className="bg-white rounded-[28px] border border-[#3F7655]/20 shadow-md p-6 sm:p-10 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-[#3F7655]/10 pb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-[#203128]">{selectedCat.name}</h2>
              ...
              <div className="flex flex-col items-start sm:items-end gap-1">
                ...
                <span className="text-xs font-bold text-[#3F7655]">{selectedCat.points}</span>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-[#3F7655]/10 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="text-xs text-[#718078]">
                Need instant check for a specific brand or item? Use our interactive checker.
              </div>

              <div className="flex items-center gap-3">
                <button
                  onClick={onOpenSearchModal}
                  className="px-4 py-2.5 bg-white border border-[#3F7655]/20 text-[#203128] text-xs font-bold rounded-xl hover:bg-[#DDEBD8] transition"
                >
                  Item Lookup Widget
                </button>
                ...
                >
                  ...
                  <span>Find recycling point →</span>
                </button>
              </div>
            </div>
